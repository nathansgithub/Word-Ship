...
//        val userRGB = "rgb(${sessionId.substring(0,2).toInt(16)},${sessionId.substring(2,4).toInt(16)},${sessionId.substring(4,6).toInt(16)})"
        val userRGB = listOf(sessionId.substring(0,2).toInt(16), sessionId.substring(2,4).toInt(16), sessionId.substring(4,6).toInt(16))
//            "rgb(${sessionId.substring(0,2).toInt(16)},${sessionId.substring(2,4).toInt(16)},${sessionId.substring(4,6).toInt(16)})"
